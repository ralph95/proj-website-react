...
const HomePage = () => {
  ...
  return (
    <MainTemplate>
      ...
      <Container centerBoth>
        <RotatingText
          texts={["Full Stack Developer", "Web Developer", "DevOps Engineer"]}
          mainClassName="px-2 sm:px-2 md:px-3 bg-[#5227ff] text-white [&_*]:text-white overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg"
          staggerFrom={"last"}
          initial={{ y: "100%" }}
          animate={{ y: 0 }}
          exit={{ y: "-120%" }}
